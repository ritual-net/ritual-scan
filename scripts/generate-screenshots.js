...
const pages = [
  {
    ...
    description: 'Main dashboard showing latest blocks, transactions, and network statistics'
  },
  {
    name: 'blocks',
    url: '/blocks',
  ...
  },
  {
    ...
    title: 'Transaction Details with Async Flow',
    description: 'Enhanced transaction details showing async transaction relationships'
  },
  {
    name: 'block-detail',
    url: '/block/75255',
  ...
  },
  {
    ...
    description: 'General blockchain analytics with charts and metrics'
  }
];
  ...
  for (const pageInfo of pages) {
    try {
      ...
      try {
        ...
        } else if (pageInfo.name === 'transaction-detail') {
          await page.waitForSelector('.text-lime-400, .bg-white\\/5', { timeout: 10000 });
        } else {
